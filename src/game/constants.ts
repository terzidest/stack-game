...
// --- FX tuning ---
export const FLASH_BOOST = 22; // lightness added at squash=1 (land hit-pop)
...
export const SHADOW_SIGMA = 6; // active-block shadow blur radius
export const SHADOW_ALPHA = 0.4; // active-block shadow opacity
